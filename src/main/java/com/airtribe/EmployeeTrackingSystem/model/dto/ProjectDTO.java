...
public class ProjectDTO {
    @NotBlank(message = "Project Title should not be empty", groups = CreateValidation.class)
    ...
    @NotNull(message = "Project Budget should not be empty", groups = CreateValidation.class)
    ...
    public ProjectDTO(String projectTitle, String projectDescription, BigDecimal projectBudget, String startDate, String endDate) {
